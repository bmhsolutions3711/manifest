#!/usr/bin/env python3
"""
AI Pulse — cloud briefing generator.
...
USER_AGENT = "AI-Pulse/1.0 (+https://github.com; hotshot-trucker-briefings; cloud-only)"
...
def build_markdown_feed_only(items: list[dict], brief_type: str, when: datetime) -> str:
    ...
    lines += [
        ...
        "---",
        "",
        "_Generated by `scripts/generate_briefing.py` on GitHub Actions. "
...
"""
    ...
    try:
        ...
        footer = (
            "\n\n---\n\n_LLM-polished cloud brief · xAI API · "
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate AI Pulse briefing (cloud)")
